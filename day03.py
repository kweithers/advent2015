...
class Point:
    ...
    def next_point(self, direction: str) -> Self:
        match direction:
            case 'v':
...
def part1(puzzle_input: str) -> int:
    ...
    houses = Counter()
    houses[current_point] += 1

    for direction in puzzle_input:
        current_point = current_point.next_point(direction)
        houses[current_point] += 1
...
def part2(puzzle_input: str) -> int:
    ...
    for n, direction in enumerate(puzzle_input):
        if n % 2 == 0:
            santa_point = santa_point.next_point(direction)
            houses[santa_point] += 1
        else:
            robo_santa_point = robo_santa_point.next_point(direction)
            houses[robo_santa_point] += 1
